...
export default function Register() {
    ...
    const handleRegister = async () => {
        ...
        if (!passwordRegex.test(newUser.password)) {
            failed("Mật khẩu phải chứa ít nhất 6 ký tự, bao gồm chữ hoa, chữ thường, số và ký tự đặc biệt");
            return;
        }
            ...
            <div className='body_register'>
                ...
                <div>
                    ...
                    <div className='body_button_register'>
                        <div>Nếu đã có tài khoản, click vào <NavLink to="/login">đây</NavLink> để đăng nhập.</div>
                    </div>
                    <div className='body_button_register'>
